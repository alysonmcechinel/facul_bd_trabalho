...
ENGINE = MyISAM DEFAULT CHARSET=utf8 COMMENT='Tipos de inscrições';
...
CREATE TABLE IF NOT EXISTS `app_goleiro`.`app_jogos` (
  ...
  `ativo` CHAR(1) NOT NULL,
  PRIMARY KEY (`id_jogo`),
  CONSTRAINT `fk_app_jogos_app_alugueis1`
    FOREIGN KEY (`id_jogo`)
    REFERENCES `app_goleiro`.`app_alugueis` (`id_jogo`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
CREATE INDEX `fk_app_jogos_app_campos1_idx` ON `app_goleiro`.`app_jogos` (`idcampo` ASC) VISIBLE;
...
CREATE TABLE IF NOT EXISTS `app_goleiro`.`app_usuarios` (
  ...
  CONSTRAINT `fk_app_usuarios_app_login`
    FOREIGN KEY (`id_usuario`)
    REFERENCES `app_goleiro`.`app_login` (`id_usuario`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  ...
  CONSTRAINT `fk_app_usuarios_app_estados1`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_app_usuarios_app_jogos1`
    FOREIGN KEY (`id_usuario`)
    REFERENCES `app_goleiro`.`app_jogos` (`id_usuario`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_app_usuarios_app_jogos2`
    FOREIGN KEY (`id_usuario`)
    REFERENCES `app_goleiro`.`app_jogos` (`id_usuario_goleiro`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
INSERT INTO `app_estados` (`id`, `nome`, `uf`, `ibge`, `pais`, `ddd`) VALUES
(1, 'Acre', 'AC', 12, 1, '68'),
...
INSERT INTO `app_paises` (`id`, `nome`, `nome_pt`, `sigla`, `bacen`) VALUES
