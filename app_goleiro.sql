-- -----------------------------------------------------
-- Criação do databaase
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `app_goleiro` DEFAULT CHARACTER SET utf8 ;
USE `app_goleiro` ;

-- -----------------------------------------------------
-- Criação das tabelas
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `app_goleiro`.`app_cidades` (
...
CREATE TABLE IF NOT EXISTS `app_goleiro`.`app_estados` (
...
CREATE TABLE IF NOT EXISTS `app_goleiro`.`app_paises` (
  `idpais` INT NOT NULL,
...
CREATE TABLE IF NOT EXISTS `app_goleiro`.`app_tipo_inscricao` (
  `idtipo_inscricao` INT NOT NULL AUTO_INCREMENT,
  `descricao` VARCHAR(45) NOT NULL,
  `ativo` CHAR(1) NOT NULL,
  PRIMARY KEY (`idtipo_inscricao`))
ENGINE = InnoDB;

CREATE TABLE IF NOT EXISTS `app_goleiro`.`app_campos` (
  ...
  CONSTRAINT `fk_app_campos_app_paises1`
    FOREIGN KEY (`idpais`)
    REFERENCES `app_goleiro`.`app_paises` (`idpais`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_app_campos_app_estados1`
    FOREIGN KEY (`idestado`)
    REFERENCES `app_goleiro`.`app_estados` (`idestado`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_app_campos_app_cidades1`
    FOREIGN KEY (`idcidade`)
    REFERENCES `app_goleiro`.`app_cidades` (`idcidade`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;

CREATE TABLE IF NOT EXISTS `app_goleiro`.`app_sexos` (
    `idtipo_sexo` INT NOT NULL,
...
CREATE TABLE IF NOT EXISTS `app_goleiro`.`app_tipo_usuarios` (
...
CREATE TABLE IF NOT EXISTS `app_goleiro`.`app_usuarios` (
  `id_usuario` INT NOT NULL AUTO_INCREMENT,
  `nome` VARCHAR(45) NOT NULL,
  `idtipo_sexo` INT NOT NULL,
  `idtipo_usuario` INT NOT NULL,
  `idtipo_inscricao` INT NOT NULL,
  ...
  CONSTRAINT `fk_app_usuarios_app_sexos1`
    FOREIGN KEY (`idtipo_sexo`)
    REFERENCES `app_goleiro`.`app_sexos` (`idtipo_sexo`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_app_usuarios_app_tipo_usuarios1`
    FOREIGN KEY (`idtipo_usuario`)
    REFERENCES `app_goleiro`.`app_tipo_usuarios` (`idtipo_usuario`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_app_usuarios_app_tipo_inscricao1`
    FOREIGN KEY (`idtipo_inscricao`)
    REFERENCES `app_goleiro`.`app_tipo_inscricao` (`idtipo_inscricao`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_app_usuarios_app_paises1`
    FOREIGN KEY (`idpais`)
    REFERENCES `app_goleiro`.`app_paises` (`idpais`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_app_usuarios_app_cidades1`
    FOREIGN KEY (`idcidade`)
    REFERENCES `app_goleiro`.`app_cidades` (`idcidade`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_app_usuarios_app_estados1`
    FOREIGN KEY (`idestado`)
    REFERENCES `app_goleiro`.`app_estados` (`idestado`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
CREATE TABLE IF NOT EXISTS `app_goleiro`.`app_jogos` (
  ...
  `id_usuario_goleiro` INT NULL,
  `ativo` CHAR(1) NOT NULL,
  PRIMARY KEY (`id_jogo`),
  CONSTRAINT `fk_app_jogos_app_campos1`
    FOREIGN KEY (`id_campo`)
    REFERENCES `app_goleiro`.`app_campos` (`id_campo`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_app_jogos_app_usuarios1`
    FOREIGN KEY (`id_usuario`)
    REFERENCES `app_goleiro`.`app_usuarios` (`id_usuario`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;

CREATE TABLE IF NOT EXISTS `app_goleiro`.`app_alugueis` (
    id_aluguel     INT NOT NULL,
    id_jogo     int not null,
    descricao     varchar(4000) not null,
    nota         decimal(4,2),
    CONSTRAINT fk_jogo FOREIGN KEY 
    (id_jogo) REFERENCES app_jogos (id_jogo)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
CREATE UNIQUE INDEX `id_campo_UNIQUE` ON `app_goleiro`.`app_campos` (`id_campo` ASC) VISIBLE;

CREATE INDEX `fk_app_campos_app_paises1_idx` ON `app_goleiro`.`app_campos` (`idpais` ASC) VISIBLE;

CREATE INDEX `fk_app_campos_app_estados1_idx` ON `app_goleiro`.`app_campos` (`idestado` ASC) VISIBLE;

CREATE INDEX `fk_app_campos_app_cidades1_idx` ON `app_goleiro`.`app_campos` (`idcidade` ASC) VISIBLE;

CREATE UNIQUE INDEX `idtipo_inscricao_UNIQUE` ON `app_goleiro`.`app_tipo_inscricao` (`idtipo_inscricao` ASC) VISIBLE;

CREATE UNIQUE INDEX `id_jogo_UNIQUE` ON `app_goleiro`.`app_alugueis` (`id_aluguel` ASC) VISIBLE;

CREATE UNIQUE INDEX `id_jogo_UNIQUE` ON `app_goleiro`.`app_jogos` (`id_jogo` ASC) VISIBLE;

CREATE INDEX `fk_app_jogos_app_campos1_idx` ON `app_goleiro`.`app_jogos` (`id_campo` ASC) VISIBLE;

CREATE UNIQUE INDEX `idtipo_usuario_UNIQUE` ON `app_goleiro`.`app_tipo_usuarios` (`idtipo_usuario` ASC) VISIBLE;

CREATE UNIQUE INDEX `idusuario_UNIQUE` ON `app_goleiro`.`app_usuarios` (`id_usuario` ASC) VISIBLE;

CREATE INDEX `fk_app_usuarios_app_sexos1_idx` ON `app_goleiro`.`app_usuarios` (`idtipo_sexo` ASC) VISIBLE;

CREATE INDEX `fk_app_usuarios_app_tipo_usuarios1_idx` ON `app_goleiro`.`app_usuarios` (`idtipo_usuario` ASC) VISIBLE;

CREATE INDEX `fk_app_usuarios_app_tipo_inscricao1_idx` ON `app_goleiro`.`app_usuarios` (`idtipo_inscricao` ASC) VISIBLE;

CREATE INDEX `fk_app_usuarios_app_paises1_idx` ON `app_goleiro`.`app_usuarios` (`idpais` ASC) VISIBLE;

CREATE INDEX `fk_app_usuarios_app_cidades1_idx` ON `app_goleiro`.`app_usuarios` (`idcidade` ASC) VISIBLE;

CREATE INDEX `fk_app_usuarios_app_estados1_idx` ON `app_goleiro`.`app_usuarios` (`idestado` ASC) VISIBLE;

CREATE TABLE IF NOT EXISTS `app_goleiro`.`app_login`
(
...
CREATE UNIQUE INDEX `id_usuario_UNIQUE` ON `app_goleiro`.`app_login` (`id_usuario` ASC) VISIBLE;

-- -----------------------------------------------------
-- Insert nas tabelas
-- -----------------------------------------------------
INSERT INTO `app_cidades` (`idcidade`, `nome`, `uf`, `ibge`) VALUES
...
INSERT INTO `app_estados` (`idestado`, `nome`, `uf`, `ibge`, `pais`, `ddd`) VALUES
(1, 'Acre', 'AC', 12, 1, '68'),
...
INSERT INTO `app_paises` (`idpais`, `nome`, `nome_pt`, `sigla`, `bacen`) VALUES
...
INSERT INTO `app_tipo_inscricao` (`idtipo_inscricao`, `descricao`, `ativo`) VALUES
(1, 'CPF' , 'S'),
(2, 'CNPJ', 'S');

INSERT INTO `app_campos` (`id_campo`, `descricao`, `idpais`, `idestado`, `idcidade`, `ativo`) VALUES
(1, 'HERIBERTO HULSE' , 1, 24, 4487, 'S'),
(2, 'DINGOS HULSE' , 1, 24, 4487, 'S'),
(3, 'ESUCRI' , 1, 24, 4487, 'S'),
(4, 'PIRÃO ESTÁDIO CLUBE' , 1, 24, 4487, 'S'),
(5, '19 DE DEZEMBRO' , 1, 24, 4673, 'S'),
(6, 'ESTRELA VERMELHA' , 1, 24, 4673, 'S'),
(7, 'CAMPO DO TRILHO' , 1, 24, 4673, 'S');

INSERT Into app_tipo_usuarios (idtipo_usuario, descricao, ativo)
values (1, 'Goleiro', 1),
       (2, 'Time', 1);

INSERT Into app_sexos (idtipo_sexo, descricao, ativo)
values (1, 'Masculino', 1),
       (2, 'Feminino', 1);

INSERT INTO `app_goleiro`.`app_usuarios`
(`id_usuario`, `nome`, `idtipo_sexo`, `idtipo_usuario`, `idtipo_inscricao`, `inscricao`, `idpais`, `idestado`, `idcidade`, `bairro`, `complemento`, `numero_casa`,`ativo`)
VALUES
(1, 'Vinicius Spada Melo', 1, 1, 1, '11111111111', 1, 24, 4673, 'Fiorita', 'Perto da igreja', 123,'S'),
(2, 'Alyson Cechinel', 1, 1, 1, '99999999999', 1, 24, 4487, 'Centrinho', 'centro mesmo', 123,'S'),
(3, 'Ronaldinho', 1, 1, 1, '123456789121', 1, 24, 4487, 'Laranjinha', 'bem perto', 123,'S'),
(4, 'Rodolfo', 1, 1, 1, '09876543212', 1, 24, 4487, 'Mineira', 'perto do mercado', 123,'S'),
(5, 'Luisinho', 1, 1, 1, '12345612345', 1, 24, 4487, 'Ouro Negro', 'so ir', 123,'S'),
(6, 'Rafael', 1, 1, 1, '11253412345', 1, 24, 4487, 'Jardim Angélica', 'primeira rua', 123,'S'),
(7, 'Wesley', 1, 1, 1, '12314521421', 1, 24, 4487, 'Ermo', 'longe', 123,'S'),
(8, 'Inativo', 1, 1, 1, '12314521421', 1, 24, 4487, 'Inativo', 'longe', 123,'N'),
(9, 'Goleirasso', 1, 2, 1, '19836417312', 1, 24, 4487, 'Inativo', 'longe', 123,'S'),
(10, 'Tafarel', 1, 2, 1, '2131237123741', 1, 24, 4487, 'Inativo', 'longe', 123,'S'),
(11, 'Rogerio Ceni', 1, 2, 1, '9999112321291', 1, 24, 4487, 'Inativo', 'longe', 123,'S');

INSERT into app_login (id_login, email_login, senha_login, id_usuario)
values (1,'braia@hotmail.com','braia123',1),
       (2,'teste@gmail.com','456123',2),
       (3,'josefino@gmail','logitecH78',3),
       (4,'Pegatudo@gmail.com','Caiotales',4),
       (5,'PauloCachaca@gmail.com','12345678',5),
       (6,'braia@goleiro.com','Avisotop',6),
       (7,'Caiojose@yahoo.com','JoseCaio',7),
       (8,'goleiro@goleiro.com','goleirin',8),
       (9,'ceni_goleiro@goleiro.com','ceni123',9),
       (10,'tafa@goleiro.com','tafaneles',10),
       (11,'cenizasso@goleiro.com','senicoms',11);

INSERT into app_jogos (id_jogo, descricao, data, horario, id_campo, id_usuario, id_usuario_goleiro, ativo)
values 
(1,'Jogo com os parcas','1999-01-01',420,1,1,null,1),
(2,'Procurando goleiro tranquilo','2020-01-04',800,1,6,null,1),
(3,'Estou ansioso, vamo q vamo','2020-03-01',1600,1,7,11,2),
(4,'Jogo vai ser pegado procurando jogador bom','2020-05-02',830,1,7,null,2),
(5,'Jogo com os parcas','2020-03-20',1830,1,2,9,1),
(6,'Jogo com os parcas','2020-05-14',2030,1,4,10,1);

INSERT into app_alugueis(id_aluguel, id_jogo, descricao, nota)
values 
(1,1,'o cara jogou muito bem nada a declarar',7.28),
(2,2,'Muito bom',10),
